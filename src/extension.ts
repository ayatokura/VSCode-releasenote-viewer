            ...
            if (response.statusCode === 200) {
                if(version.match(/tips/)) {
                    ...
                    if(version == 'vFebruary') {
                        body = body
                        .replace(/\(images\/(January\/)/g, '(https://code.visualstudio.com/images/January' + '_')
                        .replace(/\(images\/(February\/)/g, '(https://code.visualstudio.com/images/February' + '_');
                    } else {
                        body = body.replace(/\(images\/(\d*\w*\d*\/)/g, '(https://code.visualstudio.com/images/' + version.replace(/^v/,'') + '_');
                    }
                    body = body.replace(/images\/November/g,'images/0_10_0');
                }
